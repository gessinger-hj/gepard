...
- [Features](#features)
- [Changelog](#changelog)
- [See change log details](#see-change-log-details)
- [gepard](#gepard)
- [Overview](#overview-1)
- [What is new](#what-is-new-1)
	...
	- [Release 1-4-5 Registered Event-names may contain Wildcards (RegExp)](#release-1-4-5-registered-event-names-may-contain-wildcards-regexp-1)
	- [Release 1-4-5 Simplified Handling of JSON Trees](#release-1-4-5-simplified-handling-of-json-trees-1)
	- [Release 1-4-3 Logging](#release-1-4-3-logging-1)
	- [Release 1-4-0 New Heartbeat Protocol to ensure the Availability of Connections](#release-1-4-0-new-heartbeat-protocol-to-ensure-the-availability-of-connections-1)
	- [Release 1-3-3 New FileContainer class for Python, JavaScript and Java to simplify file-transfer.](#release-1-3-3-new-filecontainer-class-for-python-javascript-and-java-to-simplify-file-transfer-1)
	- [Release 1-3-0 Let's talk about Python](#release-1-3-0-lets-talk-about-python-1)
	- [Controlling Connections and Actions with a Hook](#controlling-connections-and-actions-with-a-hook-1)
	- [Perfect load balanced message handling.](#perfect-load-balanced-message-handling-1)
	- [Java bindings for all features:](#java-bindings-for-all-features-1)
- [Install](#install-1)
...
- [Use Cases](#use-cases-1)
	- [Configuration Changes (Events)](#configuration-changes-events-1)
	- [Concurrent editing of a Dataset (Semaphores)](#concurrent-editing-of-a-dataset-semaphores-1)
	- [Synchronization of file processing (Locks)](#synchronization-of-file-processing-locks-1)
	- [A Nice Exotic Mixture of Programming Languages](#a-nice-exotic-mixture-of-programming-languages-1)
- [The Event Body](#the-event-body-1)
- [Examples](#examples-1)
	- [Examples Short](#examples-short-1)
		- [Event listener](#event-listener-3)
		- [Event Emitter](#event-emitter-3)
		- [Locks](#locks-1)
		- [Semaphores](#semaphores-1)
		- [Request / Result](#request--result-1)
			- [Send request](#send-request-1)
			- [Send result](#send-result-1)
	- [Examples Long](#examples-long-1)
		- [Event listener](#event-listener-4)
			- [In Application](#in-application-2)
			- [In Browser](#in-browser-2)
		- [Event Emitter](#event-emitter-4)
			- [In Application](#in-application-3)
			- [In Browser](#in-browser-3)
- [File Transfer with the FileContainer Class](#file-transfer-with-the-filecontainer-class-1)
	- [FileSender](#filesender-1)
	- [ileReceiver](#ilereceiver-1)
- [Heartbeat and Reconnection Capability Parameterization](#heartbeat-and-reconnection-capability-parameterization-1)
	- [Broker Side](#broker-side-1)
	- [Client Side](#client-side-1)
		- [Example to test](#example-to-test-1)
- [The TracePoint Concept](#the-tracepoint-concept-1)
	- [TracePoints in the Broker](#tracepoints-in-the-broker-1)
	- [TracePoints in the Client](#tracepoints-in-the-client-1)
- [Technical Aspects of the Client](#technical-aspects-of-the-client-1)
- [Found a bug? Help us fix it...](#found-a-bug-help-us-fix-it-1)
- [https://github.com/gessinger-hj/gepard/blob/master/CHANGELOG.md](#httpsgithubcomgessinger-hjgepardblobmasterchangelogmd-1)
